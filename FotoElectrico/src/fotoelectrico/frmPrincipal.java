...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlPrincipal1 = new fotoelectrico.pnlPrincipal();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sodio", "Aluminio", "Cobre", "Zinc", "Argon" }));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        switch (material) {
            case "Sodio":
                pnlPrincipal1.colorMaterial = Color.BLACK;
                pnlPrincipal1.repaint();
                break;
            case "Aluminio":
                pnlPrincipal1.colorMaterial = Color.CYAN;
                pnlPrincipal1.repaint();
                break;
            case "Cobre":
                pnlPrincipal1.colorMaterial = Color.GRAY;
                pnlPrincipal1.repaint();
                break;
            case "Zinc":
                pnlPrincipal1.colorMaterial = Color.magenta;
                pnlPrincipal1.repaint();
                break;
            case "Argon":
                pnlPrincipal1.colorMaterial = Color.yellow;
                pnlPrincipal1.repaint();
                break;
    ...
    private fotoelectrico.pnlPrincipal pnlPrincipal1;
